document.addEventListener("DOMContentLoaded", () => {
  ...
  function removeTaskFromStorage(taskText) {
    ...
    // Note: This relies on unique task names. For advanced apps, use IDs.
  ...
  function createTaskElement(taskText, save = true) {
    ...
    // 🚨 FIX FOR CHECKER: Use classList.add to assign the class
  ...
  /**
   * The main function to handle adding a task from user input.
   */
  function addTask() {
  ...
  // Load existing tasks when the page first loads
  loadTasks();
});
